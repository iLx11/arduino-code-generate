<template>
  <div id="webserver-box" v-if="props.active">
   <span>webserver</span>
   <textarea v-model="functionCode" name="" id="" cols="30" rows="10" placeholder="请填写硬件服务器需要执行的业务逻辑代码，代码内容将直接放在函数体内"></textarea>
  </div>
</template>
...
watch(() => props.active, () => {
  webserverComp.isActived = props.active
}, {immediate: true, deep: true})
watch(functionCode, () => {
  webserverComp.configStr = functionCode.value.replace(/\n/g, '\n  ');
})
</script>
<style lang="scss">
#webserver-box {
